...
The table below reflects the **actual deterministic replay results** generated by executing `tests/replay/test_all_tickets.py` against `dhaba_tickets.json` in offline fixture mode. The verified data is stored in [tests/replay/results.json](tests/replay/results.json).
